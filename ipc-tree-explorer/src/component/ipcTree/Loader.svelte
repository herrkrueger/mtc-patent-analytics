...
out:fade={{ duration: 300 }}
  class="bg-transparent loading-blur fixed top-0 left-0 w-full h-full z-50 flex items-center justify-center {`${
    isLoading ? '' : 'hidden'
  }`}"
>
    ...
    >
      <defs>
        <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop
            offset="0%"
            style="stop-color:rgb(157,0,89); stop-opacity:0"
            id="stop1"
          />
          <stop
            offset="100%"
            style="stop-color:rgb(157,0,89); stop-opacity:1"
            id="stop2"
          />
        </linearGradient>
      </defs>
